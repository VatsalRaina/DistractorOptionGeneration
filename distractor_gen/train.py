...
def main(args):
    ...
    for item in train_data:
        ...
        for qu_num in range(len(questions)):
            ...
            opts = options[qu_num]
            corr_opt = opts[lab]
            passage_combo = context + " [SEP] " + question + " [SEP] " + corr_opt
            passage_encodings_dict = tokenizer(passage_combo, truncation=True, max_length=MAXLEN_passage, padding="max_length")
