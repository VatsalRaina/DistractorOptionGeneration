...
parser.add_argument('--distractors_path', type=str,  help='Specify path to distractors')
...
def main(args):
    ...
    with open(args.distractors_path, 'r') as f:
        all_distractors = [a.rstrip() for a in f.readlines()]

    all_gen_questions = [question + " [SEP] " + distractor for question, distractor in zip(all_questions, all_distractors)]
